...
"border: none;")
        ...
        self.enter_btn.clicked.connect(self.enterBtn_clicked)

        self.retranslateUi()
        QtCore.QMetaObject.connectSlotsByName(self)

    def enterBtn_clicked(self):
        self.db.updateUser(self.user[1][0], self.user[0][0], self.name_lineEdit.text(), self.secondname_lineEdit.text(), self.thirdname_lineEdit.text(), self.login_lineEdit.text(), self.password_lineEdit.text())
        self.close()
